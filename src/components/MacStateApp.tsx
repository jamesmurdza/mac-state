 ...
 * current sandbox descriptor and the full message history. Both are sent with every /api/stream
 * call and wholesale-replaced from the server's response -- the server holds none of it between
 * requests, so a page refresh starts a fresh sandbox and a fresh conversation.
 */
